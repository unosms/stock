                ...
                <table class="min-w-full table-fixed divide-y divide-slate-200" style="width:100%;">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        @forelse($purchases as $purchase)
                            <tr>
                                <td class="px-4 py-3 align-middle text-sm text-slate-700 whitespace-nowrap">{{ $purchase->purchased_at?->format('Y-m-d H:i') }}</td>
                                ...
                                <td class="px-4 py-3 align-middle text-right text-sm text-slate-700 whitespace-nowrap">{{ number_format($purchase->unit_price, 2) }}</td>
                                <td class="px-4 py-3 align-middle text-right text-sm text-slate-900 whitespace-nowrap">{{ number_format($purchase->quantity) }}</td>
                                <td class="px-4 py-3 align-middle text-right text-sm font-semibold text-slate-900 whitespace-nowrap">{{ number_format($purchase->total_price, 2) }}</td>
                            </tr>
                        @empty
                            <tr>
